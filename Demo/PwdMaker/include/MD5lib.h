...
int  main(argc,argv){
  char * text, *key ;
  printf("string:%sn",MDString(""));
  printf("string:%sn",MDString ("a"));
  printf("string:%sn",MDString ("abc"));
  printf("string:%sn",MDString ("message digest"));
  printf("string:%sn", MDString ("abcdefghijklmnopqrstuvwxyz"));
  printf("string:%sn",MDString("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));
  printf("string:%sn", MDString("12345678901234567890123456789012345678901234567890123456789012345678901234567890"));

  key ="Jefe";
  text ="what do ya want for nothing?";
  printf("ntext:%sn",text);
  printf("key:%sn",key);
  printf("string:%sn",hmac_md5(text,key));
  return (0);
}
