...
public:
    ...
    STDMETHOD(Next)
    (ULONG celt, IUnknown **rgelt, ULONG *pceltFetched)
    {
...
public:
    ...
    (BOOL fFocus);
    STDMETHOD(GetDC)
    (LPCRECT pRect, DWORD grfFlags, HDC *phDC);
    STDMETHOD(ReleaseDC)
    (HDC hDC);
...
CActiveXCtrl::CActiveXCtrl() : m_dwRef(1),
                               m_pOwner(NULL),
                               m_pWindow(NULL),
                               m_pUnkSite(NULL),
                               m_pViewObject(NULL),
